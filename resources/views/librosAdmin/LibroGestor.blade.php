...
<div id='app' class="vista-web">
  ...
  <div class="contenedor-contenido">
    ...
    <form
      ...
      action="{{ route('librosAdmin.gestor') }}"
      method="GET"
      ref="formFiltros">
      ...
      <div class="row-filtros-varios" v-if="cardFiltros">
        ...
        <div class="input-row botones-filtros">
          ...
          <button
            type="button"
            class="boton-expandir-filtro"
            @@click="window.location.href='{{ route('librosAdmin.gestor') }}'">
            <i class="icon-filtro"></i>
            Limpiar
          </button>
        </div>
...
<script>
  var app = new Vue({
    ...
    data: {
      ...
      // URLs
      urlLibroGestor: "/libros-admin",
      urlLibroLeerExcel: "/libros-admin/leer-excel",
      urlListarGeneros: "/libros-admin/listar-generos",
      urlListarIdiomas: "/libros-admin/listar-idiomas",
      urlListarAutores: "/libros-admin/listar-autores",
      urlListarEditoriales: "/libros-admin/listar-editoriales",
      urlLibrosAgregar: "/libros-admin/agregar",
      urlLibroEditar: "/libros-admin/editar",
      urlLibrosEliminar: "/libros-admin/eliminar",
